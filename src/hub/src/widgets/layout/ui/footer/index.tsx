...
export const Footer = () => {
  return (
    <Stack direction="row" sx={{
      ...
      <FooterLink target="_blank" href="https://github.com/relinkd/UPAS">Github</FooterLink>
      <FooterLink target="_blank" href="https://relinkd.gitbook.io/upas">DOCs</FooterLink>
    </Stack>
  )
};
